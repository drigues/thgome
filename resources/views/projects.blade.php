                   ...
                   data-animate>
                    <div class="relative aspect-[4/3] overflow-hidden rounded-2xl bg-[var(--color-bg-card)] mb-4">
                        <img src="{{ $project->thumbnail_url }}"
                             ...
                             loading="lazy">
                        <div class="absolute inset-0 bg-[var(--color-bg)]/100 group-hover:bg-[var(--color-bg)] transition-all duration-300 flex items-center justify-center">
                            <span class="text-[var(--color-text)] font-heading font-semibold text-sm opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 border border-[var(--color-border)] px-5 py-2.5 rounded-full bg-[var(--color-bg)] backdrop-blur-sm">
                                View case →
                            </span>
                        </div>
                        @if($project->category)
                        <!-- div class="absolute top-4 left-4">
                            <span class="text-xs font-medium px-3 py-1 rounded-full bg-[var(--color-bg)] backdrop-blur-sm text-[var(--color-text)] border border-[var(--color-border)]">
                        ...
                        <!-- div class="absolute top-4 right-4">
                            <span class="text-xs font-mono px-3 py-1 rounded-full bg-[var(--color-bg)] backdrop-blur-sm text-[var(--color-text-muted)] border border-[var(--color-border)] ">
                                {{ $project->year }}
                            </span>
                        </div -->
                        @endif
                    ...
                    <div>
                        ...
                        @if($project->client)
                        <p class="text-[var(--color-text-muted)] text-xs mt-2 mb-2 font-mono">
