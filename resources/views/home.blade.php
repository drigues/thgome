...
<section class="py-32 relative">
    <div class="container mx-auto px-6">
        <div class="relative mb-16">
            <span class="absolute -top-16 right-0 font-heading font-bold text-[clamp(80px,15vw,200px)] text-[var(--color-text)] opacity-[0.04] select-none leading-none">01</span>
